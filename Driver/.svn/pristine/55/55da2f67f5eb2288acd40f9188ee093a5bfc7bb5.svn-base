...
public class StartTripAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public StartTripAsyncTask(Activity context, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getStartTripData(func_id, taxi_id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
