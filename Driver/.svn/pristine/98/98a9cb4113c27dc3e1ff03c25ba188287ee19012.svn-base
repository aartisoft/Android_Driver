...
public class TwoMinuteToArriveAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public TwoMinuteToArriveAsyncTask(Activity context, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getTwoMinuteToArrive(func_id, taxi_id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
