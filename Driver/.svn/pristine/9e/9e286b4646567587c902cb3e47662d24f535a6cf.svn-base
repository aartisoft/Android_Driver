...
public class FitToDriveAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public FitToDriveAsyncTask(Activity context, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getFitToDriveData(func_id, taxi_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
