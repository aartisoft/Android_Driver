...
public class InputSimulActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mReleaseService = 1;
		final PclServiceConnection data = (PclServiceConnection) getLastNonConfigurationInstance();
        if (data == null) {
        	initService();
        }
        else
