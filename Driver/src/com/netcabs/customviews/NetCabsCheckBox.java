...
public class NetCabsCheckBox extends CheckBox {

	public NetCabsCheckBox(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(attrs);
	}
	
	public NetCabsCheckBox(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
		
	}
	
	public NetCabsCheckBox(Context context) {
		super(context);
		init(null);
	}
