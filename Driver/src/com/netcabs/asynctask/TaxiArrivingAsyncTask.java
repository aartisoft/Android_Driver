...
public class TaxiArrivingAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public TaxiArrivingAsyncTask(Activity context, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getTaxiArrivingData(func_id, taxi_id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
