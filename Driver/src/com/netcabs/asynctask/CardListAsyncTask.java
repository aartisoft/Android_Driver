...
public class CardListAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public CardListAsyncTask(Activity context, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getCardList(func_id, id);
		} catch (Exception e) {
			e.printStackTrace();
		}
